...
# Image tag for the core-operations scheduler sidecar. Normally tracks the core
# version; a separate knob so the sidecar can roll out on a release the core
# stack hasn't moved to yet (phased on-prem parity).
